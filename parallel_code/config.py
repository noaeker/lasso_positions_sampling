...
N_PARSIMONY_RAXML_SEARCH= 10
N_RANDOM_RAXML_SEARCH = 10
...
CURR_RUN_PREFIX = "run_prefix_raxml_test"
CURR_JOBS_PREFIX = "job_prefix"
LASSO_BASELINE="run_prefix_only_lasso" # "run_prefix"#"lasso_baseline"
