...
test_errors %>% head (5)
train_errors %>% summarise(median_error_pct_train = median(error_pct), mean_error_pct_train = mean(error_pct))
test_errors %>% summarise(median_error_pct_test = median(error_pct), mean_error_pct_test = mean(error_pct))
