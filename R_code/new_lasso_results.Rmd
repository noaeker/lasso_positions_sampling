...
unexplained_variance_data<- spr_data %>% filter (relative_path=="/groups/pupko/noaeker/data/LARGE_FILES_edited/_Borowiek_et_al_2015_TaxaMin30.phy")  %>% select (sample_pct,actucal_training_size,`lasso_test_R^2`, lasso_test_spearmanr) %>% mutate (unexplained_var =1-`lasso_test_R^2` )
