...
pt30 %>% select (dataset_id,job_ind,naive_SPR_spr_moves,'0_phase_lasso_SPR_spr_moves',lasso_SPR_final_phase_spr_moves,lasso_SPR_final_phase_ll,naive_SPR_ll, '0_phase_lasso_SPR_ll','0_phase_lasso_SPR_spr_moves','1_phase_lasso_SPR_ll','1_phase_lasso_SPR_spr_moves','2_phase_lasso_SPR_ll','2_phase_lasso_SPR_spr_moves', naive_SPR_ll, lasso_SPR_final_phase_ll, lasso_SPR_final_phase_spr_moves, '0_phase_ll_per_iteration','1_phase_ll_per_iteration','2_phase_ll_per_iteration', final_phase_ll_per_iteration,naive_SPR_ll_per_iteration) %>% arrange(job_ind)


ppt30<- read_csv("/Users/noa/Workspace/lasso_positions_sampling_results/30pp_t_spr.csv")
ppt30 %>% select (dataset_id,job_ind,naive_SPR_spr_moves,'0_phase_lasso_SPR_spr_moves',lasso_SPR_final_phase_spr_moves, '0_phase_lasso_SPR_ll','0_phase_lasso_SPR_spr_moves','1_phase_lasso_SPR_ll','1_phase_lasso_SPR_spr_moves','2_phase_lasso_SPR_ll','2_phase_lasso_SPR_spr_moves', naive_SPR_ll, lasso_SPR_final_phase_ll, lasso_SPR_final_phase_spr_moves,'0_phase_ll_per_iteration','1_phase_ll_per_iteration','2_phase_ll_per_iteration', final_phase_ll_per_iteration,naive_SPR_ll_per_iteration) %>% arrange(job_ind)
...
first_phase_ll_per_iteration<-c(-1056624.584320141, -1055992.6619891413, -1055847.3225711412, -1055773.9414301412, -1055766.837808141)
second_phase_ll_per_iteration<-c(-1174825.410595, -1174799.874779, -1174791.298733)
final_phase_ll_per_iteration<-c(-1174791.298733)
...
naive_ll_per_iteration<-c(-1175338.74611, -1175143.815146, -1175048.186618, -1174927.547855, -1174872.580815, -1174825.393787, -1174799.858459, -1174791.278855)
...
first_phase_ll_per_iteration<-c(-585935.778126, -585774.448745)
second_phase_ll_per_iteration<-c(-585774.448745, -585751.352759)
final_phase_ll_per_iteration<-c(-585751.352759, -585640.112014, -585580.115629, -585525.990408, -585489.927837, -585465.966722, -585443.120463)
all_lasso_phases<-c(first_phase_ll_per_iteration,second_phase_ll_per_iteration,final_phase_ll_per_iteration)
all_lasso_phase_tags<- c(rep(c("first_phase"),times=length(first_phase_ll_per_iteration)),rep(c("second_phase"),times=length(second_phase_ll_per_iteration)),rep(c("final_phase"),times=length(final_phase_ll_per_iteration)))#+rep("final_phase",length(final_phase_ll_per_iteration))
naive_ll_per_iteration<-c(-585935.778126, -585774.434172, -585660.730573, -585599.650419, -585545.595981, -585509.965189, -585485.713697, -585462.603716, -585443.121962)
naive_tags <- rep(c("naive"),times=length(naive_ll_per_iteration))
lasso_data<- tibble(phase_tag = all_lasso_phase_tags, phase_values = all_lasso_phases) %>% mutate(iteration = row_number()) 
naive_data <- tibble(phase_tag = naive_tags, phase_values = naive_ll_per_iteration) %>% mutate(iteration = row_number()) 
overall_data<- rbind(lasso_data,naive_data)
